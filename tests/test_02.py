...
class TestUserAuth:
    ...
    def setup(self):
        ...
        assert "user_id" in response1.json(), "There is no user ID in first response"
    ...
    def test_user_auth(self):
        ...
        assert self.user_id_from_auth_method == user_id_from_check_method, "User ID from auth method is not equal to" \
                                                                           "User ID from check method"
